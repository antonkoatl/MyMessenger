 ...
 * the ViewPager.
 *
 * <p>For a non-interactive indicator, see {@link android.support.v4.view.PagerTitleStrip}.</p>
 */
public class PagerTabStripAdvanced extends PagerTitleStripAdvanced {
    ...
    public PagerTabStripAdvanced(Context context) {
        this(context, null);
    }

    public PagerTabStripAdvanced(Context context, AttributeSet attrs) {
        super(context, attrs);
