 ...
 */
public class PagerTitleStripAdvanced extends ViewGroup implements ViewPagerAdvanced.Decor {
    private static final String TAG = "PagerTitleStrip";

    ViewPagerAdvanced mPager;
    TextView mPrevText;
    TextView mCurrText;
    TextView mNextText;
    ...
    public PagerTitleStripAdvanced(Context context) {
        this(context, null);
    }

    public PagerTitleStripAdvanced(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        if (!(parent instanceof ViewPagerAdvanced)) {
            throw new IllegalStateException(
                    "PagerTitleStrip must be a direct child of a ViewPager.");
        }

        final ViewPagerAdvanced pager = (ViewPagerAdvanced) parent;
    ...
    private class PageListener extends DataSetObserver implements ViewPagerAdvanced.OnPageChangeListener,
            ViewPagerAdvanced.OnAdapterChangeListener {
